...
- M8 Product & Demonstration (Integrante D) — sin empezar del lado de producto/UI (esperando la librería de componentes A2UI en Figma y la arquitectura del sitio del equipo de frontend). Lo que sí existe ya del lado de backend: `database/seeders/DemoSeeder.php` (usuario demo con perfil, portafolio diversificado, sin metas a propósito, y progreso educativo parcial) y `docs/development/demo-script.md` (10 preguntas mapeadas a las 10 tools, siguiendo los 8 pasos de "Demo Requirements" del roadmap)
